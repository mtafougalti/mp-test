...
public final class SshUtils {
	...
	public static void main(String[] args) {
		// String remoteCommandOutput = exec("ssh://osboxes:osboxes.org@192.168.56.101",
		// "lr");
		// System.out.println(remoteCommandOutput);
		String remoteShellOutput = shell("ssh://osboxes:osboxes.org@192.168.56.101", "lr");
		System.out.println(remoteShellOutput);
